...
> **⚠️ VERIFICATION REQUIRED**: Before recommending performance features (SnapStart, Provisioned Concurrency, etc.), verify current capabilities and regional availability via AWS Knowledge MCP server.
