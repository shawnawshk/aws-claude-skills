...
> **⚠️ VERIFICATION REQUIRED**: Before recommending runtime versions, Lambda features, or configurations, ALWAYS verify current information using AWS Knowledge MCP server. Lambda updates frequently with new runtimes, features, and deprecations.

## Function Definition in SAM

**Before providing runtime recommendations**: Verify current Lambda runtime versions via AWS Knowledge MCP.
