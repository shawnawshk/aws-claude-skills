...
> **⚠️ VERIFICATION REQUIRED**: Before recommending runtimes or templates, verify current options via AWS Knowledge MCP server. SAM templates and runtime versions update regularly.
